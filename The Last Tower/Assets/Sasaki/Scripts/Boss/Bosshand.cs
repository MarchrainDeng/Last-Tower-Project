...
public class BossHand : MonoBehaviour
{
    ...
    [Header("── RandomTriggerによる攻撃キャンセル ──")]
    public float cancelKnockbackDelay = 0.3f; // キャンセル〜ノックバックまでのディレイ

    [Header("── 攻撃実行ディレイ ────────────")]
    public float attackDelay = 0.3f; // Animation開始〜実際の攻撃処理までのディレイ（共通）
    ...
    // ─── RandomTriggerによる攻撃キャンセル＋ノックバック ────────────
    /// <summary>
    /// RandomTriggerSpawnerなどから呼ぶ。
    /// 一定ディレイ後、現在実行中のアクションを中断してノックバックさせる
    /// </summary>
